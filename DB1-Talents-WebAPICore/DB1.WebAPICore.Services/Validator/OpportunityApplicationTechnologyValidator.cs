...
{
    public class OpportunityApplicationTechnologyValidator : AbstractValidator<OpportunityApplicationTechnology>
    {

        public OpportunityApplicationTechnologyValidator()
        {
            //RuleFor(c => c.Name)
            //    .Length(1, 100)
